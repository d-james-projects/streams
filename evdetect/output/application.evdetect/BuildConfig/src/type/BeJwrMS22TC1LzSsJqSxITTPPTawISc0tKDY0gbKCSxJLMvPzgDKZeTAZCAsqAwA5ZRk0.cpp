...
#include "BeJwrMS22TC1LzSsJqSxITTPPTawISc0tKDY0gbKCSxJLMvPzgDKZeTAZCAsqAwA5ZRk0.h"
#include <sstream>
...
{
    instantiators_.insert(std::make_pair("tuple<rstring eventType,float32 maxTemp,rstring maxTempStation,float32 minTemp,rstring minTempStation>",&initer));
