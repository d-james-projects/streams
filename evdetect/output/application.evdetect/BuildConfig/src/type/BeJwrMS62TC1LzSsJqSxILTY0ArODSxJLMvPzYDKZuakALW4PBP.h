// t3s9eventTypes12eventStations9eventTime


#ifndef BEJWRMS62TC1LZSSJQSXILTY0ARODSXJLMVPZYDKZUAKALW4PBP_H_
#define BEJWRMS62TC1LZSSJQSXILTY0ARODSXJLMVPZYDKZUAKALW4PBP_H_
...
#define SELF BeJwrMS62TC1LzSsJqSxILTY0ArODSxJLMvPzYDKZuakALW4PBP
...
public:
    ...
    typedef SPL::rstring eventStation_type;
    typedef SPL::rstring eventTime_type;

    enum { num_attributes = 3 } ;
    
    SELF() : Tuple(), eventType_(), eventStation_(), eventTime_() {}
    SELF(const Self & ot) : Tuple(), eventType_(ot.eventType_), eventStation_(ot.eventStation_), eventTime_(ot.eventTime_) 
      { constructPayload(ot); }
    SELF(const eventType_type & _eventType, const eventStation_type & _eventStation, const eventTime_type & _eventTime) : Tuple(), eventType_(_eventType), eventStation_(_eventStation), eventTime_(_eventTime) { }
    ...
    eventStation_type & get_eventStation() { return eventStation_; }
    const eventStation_type & get_eventStation() const { return eventStation_; }
    void set_eventStation(const eventStation_type & _eventStation) { eventStation_ = _eventStation; }
    eventTime_type & get_eventTime() { return eventTime_; }
    const eventTime_type & get_eventTime() const { return eventTime_; }
    void set_eventTime(const eventTime_type & _eventTime) { eventTime_ = _eventTime; }
    ...
    {
        buf << eventType_ << eventStation_ << eventTime_;
    }
    ...
    size_t hashCode() const
    {
        ...
        s = 37 * s + std::tr1::hash<eventStation_type >()(eventStation_);
        s = 37 * s + std::tr1::hash<eventTime_type >()(eventTime_);
        return s;
    }
   ...
   size += eventStation_.getSerializedSize();
   size += eventTime_.getSerializedSize();
    ...
    { 
        ...
        eventStation_ = ot.eventStation_;
        eventTime_ = ot.eventTime_; 
        assignPayload(ot);
        return *this; 
    }
    ...
    { 
        ...
        std::swap(eventStation_, ot.eventStation_);
        std::swap(eventTime_, ot.eventTime_);
...
private:
    ...
    eventStation_type eventStation_;
    eventTime_type eventTime_;
...
#undef SELF
#endif // BEJWRMS62TC1LZSSJQSXILTY0ARODSXJLMVPZYDKZUAKALW4PBP_H_ 
