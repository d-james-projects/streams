...
MY_OPERATOR_SCOPE::MY_OPERATOR::MY_OPERATOR()
{
  ...
  */
     osi->setParameter(env, setup, "className", SPL::rstring("com.ibm.streamsx.json.TupleToJSON"));
   osi->setParameter(env, setup, "classLibrary", (SPL::Functions::Utility::getToolkitDirectory(SPL::rstring("com.ibm.streamsx.json")) + SPL::rstring("/impl/lib/com.ibm.streamsx.json.jar")));
   osi->setParameter(env, setup, "classLibrary", (SPL::Functions::Utility::getToolkitDirectory(SPL::rstring("com.ibm.streamsx.json")) + SPL::rstring("/lib/com.ibm.streamsx.json.converters.jar")));
...
bool MY_BASE_OPERATOR::globalIniter() {
    instantiators_.insert(std::make_pair("JSONOutput",&initer));
    return true;
}
...
MY_BASE_OPERATOR::MY_BASE_OPERATOR()
 : Operator()  {
    ...
    param$className$0 = SPL::rstring("com.ibm.streamsx.json.TupleToJSON");
    addParameterValue ("className", SPL::ConstValueHandle(param$className$0));
    param$classLibrary$0 = (SPL::Functions::Utility::getToolkitDirectory(SPL::rstring("com.ibm.streamsx.json")) + SPL::rstring("/impl/lib/com.ibm.streamsx.json.jar"));
    addParameterValue ("classLibrary", SPL::ConstValueHandle(param$classLibrary$0));
    param$classLibrary$1 = (SPL::Functions::Utility::getToolkitDirectory(SPL::rstring("com.ibm.streamsx.json")) + SPL::rstring("/lib/com.ibm.streamsx.json.converters.jar"));
